...
import br.com.setebit.sgr.repository.ChangeStatusRepository;
import br.com.setebit.sgr.repository.TicketRepository;
...
public class TicketServiceImpl implements TicketService {
	...
	public Page<Ticket> findByCurrentUser(int page, int count, String userId) {
		Pageable pages = PageRequest.of(page, count);
		return this.ticketRepository.findByUserIdOrderByDateDesc(pages,Long.valueOf(userId) );
	}
	...
	public Iterable<ChangeStatus> listChangeStatus(String ticketId) {
		return this.changeStatusRepository.findByTicketIdOrderByDateChangeStatusDesc( Long.valueOf(ticketId));
	}
	...
	public Page<Ticket> findByParametersAndCurrentUser(int page, int count,String title,String status,
		...
		return this.ticketRepository.
				...
				title, status, priority, Long.valueOf(userId),pages);
	}
	...
	public Page<Ticket> findByParametersAndAssignedUser(int page, int count,String title,String status,
		...
		return this.ticketRepository.
				...
				title,status,priority,Long.valueOf(assignedUserId),pages);
	}
}